...
urlpatterns = [
    ...
    path('entrenadores/edicionEntrenador/<idEntrenador>', views.edicionEntrenador),
...
urlpatterns = [
    ...
    path('cobro/', views.cobro),
    path('cobro/registrarCobro/', views.registrarCobro),
    path('cobro/edicionCobro/<idCobro>', views.edicionCobro),
    path('cobro/editarCobro/', views.editarCobro),
