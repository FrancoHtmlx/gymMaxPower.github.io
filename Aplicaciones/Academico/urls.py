...
urlpatterns = [
    ...
    path('cajas/registrarCaja/', views.registrarCaja, name='registrarCaja'),
    path('cajas/edicionCaja/<idCaja>/', views.edicionCaja, name='edicionCaja'),
    path('cajas/editarCaja/', views.editarCaja, name='editarCaja'),
    path('cajas/eliminarCaja/<idCaja>/', views.eliminarCaja, name='eliminarCaja'),

    path('productos/', views.productos, name='productos'),
    path('productos/registrarProducto/', views.registrarProducto, name='registrarProducto'),
    path('productos/edicionProductos/<idProducto>', views.edicionProducto, name='edicionProducto'),
    path('productos/editarProducto/', views.editarProducto, name='editarProducto'),
    path('productos/eliminarProducto/<idProducto>', views.eliminarProducto, name='eliminarProducto'),
